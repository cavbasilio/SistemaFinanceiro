...
<form action="atualizaPagamento.php" method="POST" id="form"> 
                <?php
                   
                    $sqlInsert = "SELECT * FROM `tblclientes` WHERE idCliente = $id";
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="prevPagamento">
                </div>
